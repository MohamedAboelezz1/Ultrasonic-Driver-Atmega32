...
/* ULTRASONIC HW Ports and Pins */
#define ULUTRASONIC_TRIGGER_PORT_ID                 PORTB_ID
#define ULUTRASONIC_TRIGGER_PIN_ID                  PIN5_ID

#define ULUTRASONIC_ECHO_PORT_ID                  PORTD_ID
#define ULUTRASONIC_ECHO_PIN_ID                   PIN6_ID
